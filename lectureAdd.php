                    ...
                    <form class="form-horizontal needs-validation" novalidate method="post" action="" id="reg">
                      ...
                      <div class="col-4">
                        ...
                        <div class="col-4">
                         ...
                         <div class="col-4">
                         <lable>Role :</lable>
                          <select class="form-control" id="role" name="role" size="" value="" required>
          ...
          while($row=mysqli_fetch_array($query1)){
           ...
           ?>
                       ...
                       <div class="col-4">
                        ...
                        <textarea name="quli" clos="5" rows="10" class="form-control" required></textarea>
...
<?php 
      if(isset($_POST['submit'])){
        ...
        $date=date('Y-m-d');
        $insert=mysqli_query($con,"INSERT INTO academic(FullName,Profession,RegNo,Role,Username,Password,status,RegDate,Work,Qualification) VALUES('$fnm','$prf','$regno','$role','$uname','$enp',1,'$date','$work','$quli')");//database connection opened
