              ...
              <div class="card-body">
                ...
                <div class="card">
                  <div class="card-header">
                     ...
                     <a href="chemicalissueviews.php" class="btn btn-danger fa fa-eye btn-sm">views</a>
                  </div>
...
$select=mysqli_query($con,"SELECT * FROM chemissue");
