...
<?php 
          ...
          while($row=mysqli_fetch_array($query)){
           ...
           ?>
                         ...
                         <div class="col-4">
                          <lable>Department :
                          <select class="form-control" id="dpt" name="dpt" size="">
                           
<?php 
          $query=mysqli_query($con,"SELECT * FROM deparment WHERE Id='$dpt' ");
          while($row=mysqli_fetch_array($query)){
            $id=$row['Id'];
            $dptnm=$row['DepartmentName'];
           ...
           ?> 
        <?php 
          $query=mysqli_query($con,"SELECT * FROM deparment  ");
          while($row=mysqli_fetch_array($query)){
            $id=$row['Id'];
            $dptnm=$row['DepartmentName'];
            echo '<option value="'.$id.'">'.$dptnm.'</option>';
           ...
           ?>  
                        ...
                        <div class="col-4">
                          ...
                          <input class="form-control" type="text"  name="regno" id="regno" required value="<?php echo $regno; ?>">
                           ...
                           <div class="col-4">
                         <lable>Role :</lable>
                         <input class="form-control" type="text"  name="role" id="role" value="non-academic" value="<?php echo $role;  ?>" required readonly>
                      </div>
