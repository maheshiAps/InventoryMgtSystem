...
<?php  
    ...
    include 'dbcon.php';
    $request=mysqli_query($con,"SELECT * FROM nonacademic WHERE status ='1'");
    ...
    <div class="card-header">
                    ...
                    <a href="nonacaadd.php" class="btn btn-danger btn-sm fa fa-plus">New</a></div>
  ...
  while($row=mysqli_fetch_array($request)){
        ...
        ?>
                  <tr>
                    ...
                    <td><a href="nonacaview.php?id=<?php echo $empcode; ?>" class="btn btn-success btn-sm fa fa-eye">View</a></td>
