...
<?php
 ...
 ?> 
                    ...
                    <form class="form-horizontal" action="" method="post">
                      ...
                      <div class="form-group row">
                        <div class="col-4" for="chemnm">
                          <lable>Material Name:
                          <input class="form-control" type="text" placeholder="" name="materialnm" required></lable>
      ...
      if(isset($_POST['submit'])){
        ...
        $materialnm=$_POST['materialnm'];
        
        $stocklevel=$_POST['stocklevel'];
        $insert=mysqli_query($con,"INSERT INTO materiallist(MaterialName,Minpoint) VALUES('$materialnm','$stocklevel')");//database connection opened
